...
_ARCHIVE_FILE_NAME="${_SOURCE_DIRECTORY_BASENAME}-$(date '+%Y-%m-%d').tar"
...
ssh "${_SOURCE_HOST}" "sudo tar -cvf ${_ARCHIVE_FILE_NAME} -C ${_SOURCE_DIRECTORY_DIRNAME}/ ${_SOURCE_DIRECTORY_BASENAME}"

...
| [**NAS LXC Container**](./nas-lxc-container.md)                             | NixOS LXC containers on each Proxmox node exposing host ZFS datasets as NFS and SMB shares via bind mounts, with Terraform provisioning.                 | **Work in progress**          |

...
[Testing Spec - Dynamic Discovery](./declarative-integration-testing.md#33-flake-integration--dynamic-test-discovery-confignixflakenix)).
...
- **VM Resource (`proxmox_virtual_environment_vm.hl02`):**
    ...
    - **Installer CDROM (`ide2`):** Mounts the custom installer ISO (uploaded
      ...
      [Bootstrapping Spec - Custom ISO](./home-lab-bootstrapping.md#41-nix-native-custom-iso-confignixflakenix)).
...
## 6. Deployment & Bootstrapping

The deployment of `hl02` follows the standardized bootstrapping workflow
detailed in the
[Home Lab Bootstrapping Spec - Deployment Workflow](./home-lab-bootstrapping.md#5-bootstrapping--deployment-workflow).
